 ...
 * @datetime 2022-08-08 16:34 Monday
 */
public class FileUtils {
    /**
     * Determine whether the directory of the specified path exists, and create it if it does not exist
     */
     ...
     */
    public static boolean compress(String srcDirectoryPath, String fileSavePath) {
        ...
        try {
            File dstCompressFile = new File(fileSavePath);
    ...
    public static boolean writeStringContent(String content, String filePath) {
        ...
        try {
            ...
            content = "[" + DateUtils.parseDatetime(new Date()) + "]\n" + content;
