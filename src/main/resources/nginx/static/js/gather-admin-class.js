$(function () {
    ...
    var invalidImageUrl = "https://whut.springbear2020.cn/static/img/invalid.png";
    var notLoginImageUrl = "https://whut.springbear2020.cn/static/img/notLogin.png";
    var notUploadImageUrl = "https://whut.springbear2020.cn/static/img/notUpload.png";
    ...
    function getClassUploadRecord(date) {
        $.ajax({
            url: contextPath + "admin/record/class.json",
            data: "date=" + date,
            dataType: "json",
            type: "get",
            ...
            error: function () {
                showNoticeModal(CODE_ERROR, "请求班级上传记录失败，请稍后重试");
            }
        })
    }
    ...
    function buildTopHistoryDate(currentDate, days) {
        ...
        // View the specified day history click event
